  ...
  return (
    <div style="max-width:640px;margin:0 auto;padding:var(--space-4) var(--space-4) var(--space-8)">
      ...
      <VersionEntry
        ...
        date="2026-05-11"
        items={[
          t('changelog.v0998_8_item_1'),
          t('changelog.v0998_8_item_2'),
        ]}
        current
      />
      <VersionEntry
        ...
        date="2026-05-03"
        items={[
          t('changelog.v0998_7_item_1'),
          t('changelog.v0998_7_item_2'),
        ]}
      />
      <VersionEntry
        version="v0.99.8.6"
        date="2026-05-01"
        items={[
          t('changelog.v0998_6_item_1'),
          t('changelog.v0998_6_item_2'),
        ]}
      />
      <VersionEntry
        version="v0.99.8.5"
        date="2026-04-29"
        items={[
          t('changelog.v0998_5_item_1'),
          t('changelog.v0998_5_item_2'),
        ]}
      />
      <VersionEntry
        version="v0.99.8.4"
        date="2026-04-29"
        items={[
          t('changelog.v0998_4_item_1'),
          t('changelog.v0998_4_item_2'),
        ]}
      />
      <VersionEntry
        version="v0.99.8.3"
